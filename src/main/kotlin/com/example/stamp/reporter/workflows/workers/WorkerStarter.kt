...
class WorkerStarter(
    ...
    init {
        ...
        logger.info("Started $numberOfWorkers workers")
    }

    @EventListener(ApplicationReadyEvent::class)
    fun spawnThreads() {
        workerContexts.forEachIndexed { index, it ->
            logger.trace("WakeUp of thread $index with workerId ${it.worker.workerId}")
    ...
    fun newWorkerDaemon(isShuttingDown: AtomicBoolean) =
        WorkerDaemon(
            ...
            sendToExchangeStepper = sendToExchangeStepper,
